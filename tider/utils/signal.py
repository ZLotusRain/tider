"""Implementation of the Observer pattern taken from `celery`."""
import sys
import threading
import weakref
...
from tider.local import Proxy, PromiseProxy
from tider.utils.functional import fun_accepts_kwargs
...
class Signal:  # pragma: no cover
    ...
    def _remove_receiver(self, receiver=None):
        ...
        # garbage collection, and so the call can happen while we are already
        # holding self.lock.
